class Petsc < Formula
  ...
  bottle do
    ...
    revision 2
    sha1 "5beacf11c6d49d1426c8371bde90e174a2272048" => :yosemite
    sha1 "14f57231a0286127faef05b6ae710820c599b722" => :mavericks
    sha1 "34db741378dc282b7a647367155b108be1787692" => :mountain_lion
  end
